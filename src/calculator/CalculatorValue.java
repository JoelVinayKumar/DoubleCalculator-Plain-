...
public class CalculatorValue {
	...
	**********************************************************************************************/
	...
	/*****
	 * The following methods have not been implemented.  The code here is just a stub to allow the
	 * code to properly compile and run.
	 * 
	 * @param v
	 */
	...
	public void div(CalculatorValue v) {
		if(v.measuredValue == 0) {
			errorMessage = "Zero Division Error. This operation cannot be performed";
		}
		else {
			measuredValue = measuredValue/v.measuredValue;
			errorMessage = "";
	...
	public void sqr(CalculatorValue v) {
