...
public class MeasuredValueRecognizer {
	 ...
	 * @version 0.10		2018-02-14	Cases 5,6,7 are updated according to FSM diagram
	 * 
	 */
	...
	public static String checkMeasureValue(String input) {
		...
		while (running) {
			...
			case 8: 
				...
				// If the current character is in the range from 1 to 9, it transitions to state 9
				if (currentChar == '.') {
					nextState = 9;
					break;
				}
		...
		case 8:
			...
			// a dot.
			measuredValueErrorMessage = "This character may only be a dot"
					+ ".\n";
			return measuredValueErrorMessage + displayInput(input, currentCharNdx);
		case 9:
