 ...
 * @version 4.01	2019-02-25	Test cases have been updated to double values
 * 
 */
...
public class TestBusinessLogic {
	...
	public static void main(String[] args) {
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("\nReturned string = 9.9999999E7\n******************\n" + 
				"*\n" + 
				"* Business Logic\n" + 
				"*\n" + 
				"******************\n" + 
				"operand1 = 1.2345678E7\n" + 
				"     operand1ErrorMessage = \n" + 
				"     operand1Defined = true\n" + 
				"operand2 = 8.7654321E7\n" + 
				"     operand2ErrorMessage = \n" + 
				"     operand2Defined = true\n" + 
				"result = 9.9999999E7\n" +
				"     resultErrorMessage = \n" + 
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("\nReturned string = 1.082152022374638E15\n******************\n" + 
				"*\n" + 
				"* Business Logic\n" + 
				"*\n" + 
				"******************\n" + 
		...
		// Check the actual output against the expected.  If they match, the test has been passed and display the proper
		// message and tally the result
		if (check("\nReturned string = 0.1408450588534021\n******************\n" + 
				"*\n" + 
				"* Business Logic\n" + 
				"*\n" + 
				"******************\n" + 
